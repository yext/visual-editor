...
export type FormalFinderAboutSectionProps = {
...
const FormalFinderAboutSectionFields: Fields<FormalFinderAboutSectionProps> = {
  heading: createStyledTextField("Heading"),
  items: {
    label: "Items",
    type: "array",
    getItemSummary: () => "About Item",
    defaultItemProps: {
...
export const FormalFinderAboutSectionComponent: PuckComponent<
...
> = (props) => {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 border-y border-[#dde1e7] py-6 md:grid-cols-3">
...
export const FormalFinderAboutSection: ComponentConfig<FormalFinderAboutSectionProps> =
  {
    label: "Formal Finder About Section",
    fields: FormalFinderAboutSectionFields,
    defaultProps: {
      heading: createStyledTextDefault(
        "Built for clients who want steadiness and clarity",
        32,
        "#1a2230",
        700,
      ),
      items: [
        {
          title: createStyledTextDefault("Tax planning", 17, "#1a2230", 700),
          body: createStyledTextDefault(
            "Forward-looking guidance instead of a once-a-year scramble.",
            16,
            "#1a2230",
            400,
          ),
        },
        {
          ...
          body: createStyledTextDefault(
            "Clear monthly and quarterly structure for owners who need better visibility.",
            16,
            "#1a2230",
            400,
          ),
        },
        {
          ...
          body: createStyledTextDefault(
            "Direct answers and practical next steps without adding unnecessary complexity.",
            16,
            "#1a2230",
            400,
          ),
    ...
    render: FormalFinderAboutSectionComponent,
  };
