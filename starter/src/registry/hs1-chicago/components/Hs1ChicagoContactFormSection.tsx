...
export type Hs1ChicagoContactFormSectionProps = {
...
const fields: Fields<Hs1ChicagoContactFormSectionProps> = {
...
export const Hs1ChicagoContactFormSectionComponent: PuckComponent<
  ...
  return (
    <section className="bg-[#d0c0bd] px-6 py-14 max-md:px-4 max-md:py-12">
      <div className="mx-auto max-w-[700px] text-center">
        ...
        <form className="mt-7 space-y-3 rounded bg-white/30 p-6">
...
export const Hs1ChicagoContactFormSection: ComponentConfig<Hs1ChicagoContactFormSectionProps> =
  {
    label: "HS1 Chicago Contact Form Section",
    fields,
    defaultProps: {
      heading: makeText("Contact Us", 28, "#ffffff", 500, "uppercase"),
      caption: makeText(
      ...
      fields: [
        ...
        { placeholder: "Notes to the Doctor", inputType: "textarea" },
      ],
      disclaimer: makeText(
    ...
    render: Hs1ChicagoContactFormSectionComponent,
  };
