...
export type Hs1AlbanyNewPatientsContactFormSectionProps = {
...
export const Hs1AlbanyNewPatientsContactFormSectionFields: Fields<Hs1AlbanyNewPatientsContactFormSectionProps> =
  {
...
export const Hs1AlbanyNewPatientsContactFormSection: ComponentConfig<Hs1AlbanyNewPatientsContactFormSectionProps> =
  {
    ...
    fields: Hs1AlbanyNewPatientsContactFormSectionFields,
    defaultProps: {
      title: {
        text: {
          field: "",
