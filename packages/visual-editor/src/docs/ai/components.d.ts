...
import {
  ...
  T as ThemeConfig,
  C as ComboboxOption,
  a as TranslatableString,
  b as TranslatableRichText,
  c as TailwindConfig,
  d as ComboboxOptionGroup,
  M as MsgString,
  e as ThemeOptions,
  R as RichText,
  P as PresetImageType,
  H as HeadingLevel,
  f as TranslatableAssetImage,
  E as EnhancedTranslatableCTA,
  A as AssetImageType,
  g as PromoSectionType,
  F as FAQSectionType,
  h as AssetVideo,
  i as ProductSectionType,
  j as ProductStruct,
  k as EventSectionType,
  l as EventStruct,
  I as InsightSectionType,
  m as InsightStruct,
  n as FAQStruct,
  o as TeamSectionType,
  p as PersonStruct,
  q as TestimonialSectionType,
  r as TestimonialStruct,
  s as TranslatableCTA,
} from "./tailwind-D5fYUK0k.js";
import {
  LinkType,
