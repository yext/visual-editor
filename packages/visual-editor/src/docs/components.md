...
| `locationStyles`      | `Array<{ entityType: string; pinIcon?: { type: "none" \| "icon"; iconName?: string; }; pinColor?: BackgroundStyle; }>` | Location styles per entity type. The number of entries is locked to the locator entity types for the page set.        |                                        |
...
| `resultCard`          | `Array<{ entityType: string; props: LocatorResultCardProps; }>`                                                        | Result card properties per entity type. The number of entries is locked to the locator entity types for the page set. |                                        |
