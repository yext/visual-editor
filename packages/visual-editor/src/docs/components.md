...
![Preview of the HeroSection component](../components/testing/screenshots/HeroSection/%5Bdesktop%5D%20%5Bclassic%5D%20version%2014%20props%20using%20constant%20values.png)
...
| `styles.image`                    | `ImageStylingProps`                                    | Styling options for the hero image, such as aspect ratio (classic variant).                                                                    |                      |
