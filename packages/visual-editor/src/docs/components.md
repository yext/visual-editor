...
| `resultCard.address`          | `{ showGetDirectionsLink: boolean; liveVisibility: boolean; }`                                                            |                                                                                     |                                        |
| `resultCard.email`            | `{ field: string; liveVisibility: boolean; }`                                                                             |                                                                                     |                                        |
| `resultCard.hours`            | `{ table: Omit<HoursTableProps["styles"], "alignment" \| "showAdditionalHoursText">; liveVisibility: boolean; }`          |                                                                                     |                                        |
| `resultCard.icons`            | `boolean`                                                                                                                 |                                                                                     |                                        |
| `resultCard.image`            | `{ field?: string; liveVisibility: boolean; }`                                                                            |                                                                                     |                                        |
| `resultCard.phone`            | `{ field: string; phoneFormat: "domestic" \| "international"; includePhoneHyperlink: boolean; liveVisibility: boolean; }` |                                                                                     |                                        |
| `resultCard.primaryCTA`       | `{ variant: CTAVariant; liveVisibility: boolean; }`                                                                       |                                                                                     |                                        |
| `resultCard.primaryHeading`   | `{ field: string; headingLevel: HeadingLevel; }`                                                                          |                                                                                     |                                        |
| `resultCard.secondaryCTA`     | `{ variant: CTAVariant; liveVisibility: boolean; }`                                                                       |                                                                                     |                                        |
| `resultCard.secondaryHeading` | `{ field?: string; variant: BodyProps["variant"]; }`                                                                      |                                                                                     |                                        |
| `resultCard.services`         | `{ field: string; liveVisibility: boolean; }`                                                                             |                                                                                     |                                        |
| `resultCard.tertiaryHeading`  | `{ field?: string; variant: BodyProps["variant"]; }`                                                                      |                                                                                     |                                        |
