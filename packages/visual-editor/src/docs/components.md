...
| `filters`             | `{ openNowButton: boolean; showDistanceOptions: boolean; accentColor?: ThemeColor; facetFields?: DynamicMultiSelectValue<string>; }` | Configuration for the filters available in the locator search experience.                                                                                                                                                        |                                        |
