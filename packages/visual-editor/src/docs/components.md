...
| `resultCard.email`            | `{ field: string; liveVisibility: boolean; }`                                                                             | Settings for the email block                                                        |                                        |
| `resultCard.hours`            | `{ table: Omit<HoursTableProps["styles"], "alignment" \| "showAdditionalHoursText">; liveVisibility: boolean; }`          | Settings for the hours block                                                        |                                        |
| `resultCard.icons`            | `boolean`                                                                                                                 | Whether to show icons for certain fields                                            |                                        |
| `resultCard.image`            | `{ field?: string; liveVisibility: boolean; }`                                                                            | Settings for the image                                                              |                                        |
| `resultCard.phone`            | `{ field: string; phoneFormat: "domestic" \| "international"; includePhoneHyperlink: boolean; liveVisibility: boolean; }` | Settings for the phone block                                                        |                                        |
...
| `resultCard.secondaryCTA`     | `{ variant: CTAVariant; liveVisibility: boolean; }`                                                                       | Settings for the secondary CTA                                                      |                                        |
