...
const SyntheticTemplate02Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate02Config}
          data={data}
...
export default SyntheticTemplate02Template;
