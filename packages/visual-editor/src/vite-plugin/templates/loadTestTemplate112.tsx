...
const SyntheticTemplate112Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate112Config}
          data={data}
...
export default SyntheticTemplate112Template;
