...
const SyntheticTemplate102Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate102Config}
          data={data}
...
export default SyntheticTemplate102Template;
