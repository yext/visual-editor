...
const SyntheticTemplate104Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate104Config}
          data={data}
...
export default SyntheticTemplate104Template;
