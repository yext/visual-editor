...
const SyntheticTemplate35Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate35Config}
          data={data}
...
export default SyntheticTemplate35Template;
