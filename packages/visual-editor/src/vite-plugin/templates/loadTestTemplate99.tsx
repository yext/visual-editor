...
const SyntheticTemplate99Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate99Config}
          data={data}
...
export default SyntheticTemplate99Template;
