...
const SyntheticTemplate06Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate06Config}
          data={data}
...
export default SyntheticTemplate06Template;
