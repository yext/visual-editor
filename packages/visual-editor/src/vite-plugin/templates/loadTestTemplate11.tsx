...
const SyntheticTemplate11Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate11Config}
          data={data}
...
export default SyntheticTemplate11Template;
