...
const SyntheticTemplate78Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate78Config}
          data={data}
...
export default SyntheticTemplate78Template;
