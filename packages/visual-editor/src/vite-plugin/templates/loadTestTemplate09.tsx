...
const SyntheticTemplate09Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate09Config}
          data={data}
...
export default SyntheticTemplate09Template;
