...
const SyntheticTemplate43Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate43Config}
          data={data}
...
export default SyntheticTemplate43Template;
