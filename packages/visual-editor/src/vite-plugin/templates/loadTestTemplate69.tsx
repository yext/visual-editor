...
const SyntheticTemplate69Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate69Config}
          data={data}
...
export default SyntheticTemplate69Template;
