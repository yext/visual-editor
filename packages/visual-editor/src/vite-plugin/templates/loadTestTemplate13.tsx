...
const SyntheticTemplate13Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate13Config}
          data={data}
...
export default SyntheticTemplate13Template;
