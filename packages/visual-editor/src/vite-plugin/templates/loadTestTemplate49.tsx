...
const SyntheticTemplate49Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate49Config}
          data={data}
...
export default SyntheticTemplate49Template;
