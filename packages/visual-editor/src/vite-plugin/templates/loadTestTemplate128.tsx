...
const SyntheticTemplate128Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate128Config}
          data={data}
...
export default SyntheticTemplate128Template;
