...
const SyntheticTemplate08Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate08Config}
          data={data}
...
export default SyntheticTemplate08Template;
