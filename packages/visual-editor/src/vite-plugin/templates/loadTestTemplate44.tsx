...
const SyntheticTemplate44Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate44Config}
          data={data}
...
export default SyntheticTemplate44Template;
