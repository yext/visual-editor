...
const SyntheticTemplate116Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate116Config}
          data={data}
...
export default SyntheticTemplate116Template;
