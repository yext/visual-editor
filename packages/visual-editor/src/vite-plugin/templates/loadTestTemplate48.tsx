...
const SyntheticTemplate48Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate48Config}
          data={data}
...
export default SyntheticTemplate48Template;
