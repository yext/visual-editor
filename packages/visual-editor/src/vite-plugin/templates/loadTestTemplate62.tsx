...
const SyntheticTemplate62Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate62Config}
          data={data}
...
export default SyntheticTemplate62Template;
