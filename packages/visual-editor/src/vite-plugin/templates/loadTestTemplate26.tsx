...
const SyntheticTemplate26Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate26Config}
          data={data}
...
export default SyntheticTemplate26Template;
