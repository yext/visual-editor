...
const SyntheticTemplate33Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate33Config}
          data={data}
...
export default SyntheticTemplate33Template;
