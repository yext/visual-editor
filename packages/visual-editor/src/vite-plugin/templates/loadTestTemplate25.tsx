...
const SyntheticTemplate25Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate25Config}
          data={data}
...
export default SyntheticTemplate25Template;
