...
const SyntheticTemplate68Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate68Config}
          data={data}
...
export default SyntheticTemplate68Template;
