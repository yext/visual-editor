...
const SyntheticTemplate46Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate46Config}
          data={data}
...
export default SyntheticTemplate46Template;
