...
const SyntheticTemplate107Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate107Config}
          data={data}
...
export default SyntheticTemplate107Template;
