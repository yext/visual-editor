...
const SyntheticTemplate57Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate57Config}
          data={data}
...
export default SyntheticTemplate57Template;
