...
const SyntheticTemplate03Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate03Config}
          data={data}
...
export default SyntheticTemplate03Template;
