...
const SyntheticTemplate14Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate14Config}
          data={data}
...
export default SyntheticTemplate14Template;
