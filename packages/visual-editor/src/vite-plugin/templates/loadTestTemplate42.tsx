...
const SyntheticTemplate42Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate42Config}
          data={data}
...
export default SyntheticTemplate42Template;
