...
const SyntheticTemplate118Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate118Config}
          data={data}
...
export default SyntheticTemplate118Template;
