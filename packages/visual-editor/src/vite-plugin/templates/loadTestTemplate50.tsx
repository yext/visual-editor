...
const SyntheticTemplate50Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate50Config}
          data={data}
...
export default SyntheticTemplate50Template;
