...
const SyntheticTemplate23Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate23Config}
          data={data}
...
export default SyntheticTemplate23Template;
