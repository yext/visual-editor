...
const SyntheticTemplate124Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate124Config}
          data={data}
...
export default SyntheticTemplate124Template;
