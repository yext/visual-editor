...
const SyntheticTemplate92Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate92Config}
          data={data}
...
export default SyntheticTemplate92Template;
