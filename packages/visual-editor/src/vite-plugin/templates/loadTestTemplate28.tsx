...
const SyntheticTemplate28Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate28Config}
          data={data}
...
export default SyntheticTemplate28Template;
