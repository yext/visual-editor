...
const SyntheticTemplate64Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate64Config}
          data={data}
...
export default SyntheticTemplate64Template;
