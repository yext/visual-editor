...
const SyntheticTemplate31Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate31Config}
          data={data}
...
export default SyntheticTemplate31Template;
