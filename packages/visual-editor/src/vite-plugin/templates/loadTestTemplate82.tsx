...
const SyntheticTemplate82Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate82Config}
          data={data}
...
export default SyntheticTemplate82Template;
