...
const SyntheticTemplate37Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate37Config}
          data={data}
...
export default SyntheticTemplate37Template;
