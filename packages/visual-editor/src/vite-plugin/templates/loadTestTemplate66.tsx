...
const SyntheticTemplate66Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate66Config}
          data={data}
...
export default SyntheticTemplate66Template;
