...
const SyntheticTemplate113Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate113Config}
          data={data}
...
export default SyntheticTemplate113Template;
