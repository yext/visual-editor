...
const SyntheticTemplate83Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate83Config}
          data={data}
...
export default SyntheticTemplate83Template;
