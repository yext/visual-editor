...
const SyntheticTemplate123Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate123Config}
          data={data}
...
export default SyntheticTemplate123Template;
