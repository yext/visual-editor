...
const SyntheticTemplate72Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate72Config}
          data={data}
...
export default SyntheticTemplate72Template;
