...
const SyntheticTemplate52Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate52Config}
          data={data}
...
export default SyntheticTemplate52Template;
