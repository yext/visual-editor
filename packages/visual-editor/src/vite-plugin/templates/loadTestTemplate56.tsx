...
const SyntheticTemplate56Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate56Config}
          data={data}
...
export default SyntheticTemplate56Template;
