...
const SyntheticTemplate100Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate100Config}
          data={data}
...
export default SyntheticTemplate100Template;
