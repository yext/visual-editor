...
const SyntheticTemplate96Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate96Config}
          data={data}
...
export default SyntheticTemplate96Template;
