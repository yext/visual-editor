...
const SyntheticTemplate17Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate17Config}
          data={data}
...
export default SyntheticTemplate17Template;
