...
const SyntheticTemplate95Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate95Config}
          data={data}
...
export default SyntheticTemplate95Template;
