...
const SyntheticTemplate01Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate01Config}
          data={data}
...
export default SyntheticTemplate01Template;
