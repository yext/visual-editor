...
const SyntheticTemplate94Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate94Config}
          data={data}
...
export default SyntheticTemplate94Template;
