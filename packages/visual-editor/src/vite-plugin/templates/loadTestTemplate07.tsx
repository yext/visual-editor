...
const SyntheticTemplate07Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate07Config}
          data={data}
...
export default SyntheticTemplate07Template;
