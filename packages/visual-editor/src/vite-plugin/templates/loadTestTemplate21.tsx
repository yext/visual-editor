...
const SyntheticTemplate21Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate21Config}
          data={data}
...
export default SyntheticTemplate21Template;
