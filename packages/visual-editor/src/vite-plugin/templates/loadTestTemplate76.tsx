...
const SyntheticTemplate76Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate76Config}
          data={data}
...
export default SyntheticTemplate76Template;
