...
const SyntheticTemplate121Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate121Config}
          data={data}
...
export default SyntheticTemplate121Template;
