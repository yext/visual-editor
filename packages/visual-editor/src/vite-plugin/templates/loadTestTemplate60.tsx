...
const SyntheticTemplate60Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate60Config}
          data={data}
...
export default SyntheticTemplate60Template;
