...
const SyntheticTemplate127Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate127Config}
          data={data}
...
export default SyntheticTemplate127Template;
