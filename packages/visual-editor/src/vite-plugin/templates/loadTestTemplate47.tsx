...
const SyntheticTemplate47Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate47Config}
          data={data}
...
export default SyntheticTemplate47Template;
