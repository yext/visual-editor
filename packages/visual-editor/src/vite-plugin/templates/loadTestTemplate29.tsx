...
const SyntheticTemplate29Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate29Config}
          data={data}
...
export default SyntheticTemplate29Template;
