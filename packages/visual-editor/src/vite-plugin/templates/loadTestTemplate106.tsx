...
const SyntheticTemplate106Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate106Config}
          data={data}
...
export default SyntheticTemplate106Template;
