...
const SyntheticTemplate91Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate91Config}
          data={data}
...
export default SyntheticTemplate91Template;
