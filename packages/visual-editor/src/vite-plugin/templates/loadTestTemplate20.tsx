...
const SyntheticTemplate20Template: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
  ...
  return (
    ...
    >
      <VisualEditorProvider templateProps={props}>
        <Render
          config={loadTestTemplate20Config}
          data={data}
...
export default SyntheticTemplate20Template;
