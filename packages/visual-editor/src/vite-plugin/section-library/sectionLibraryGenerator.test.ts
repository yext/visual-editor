...
describe("generateSectionLibraryFiles", () => {
  ...
  it("generates a render template for every Entity layout", () => {
    const rootDir = createLibrary();
    addEntityLayout(rootDir, "alpha-location");
  ...
  it("threads an optional repo migration registry through generated editor and render templates", () => {
    const rootDir = createLibrary();
    fs.outputFileSync(
      path.join(rootDir, "src", "library", "migrations", "registry.ts"),
      [
        'import type { MigrationRegistry } from "@yext/visual-editor";',
    ...
    expect(renderSource.indexOf("migrate(")).toBeLessThan(
      renderSource.indexOf("resolveAllData(")
    );
  ...
  it.each([
    ...
    },
    {
      ...
      update: (rootDir: string): void => {
        addEntityLayout(rootDir, "edit-location");
      },
    ...
    },
    {
      ...
      update: (rootDir: string): void => {
        addEntityLayout(rootDir, "local-editor-data-location");
      },
      error:
    ...
    },
    {
      ...
      update: (rootDir: string): void => {
        addEntityLayout(rootDir, "location_");
      },
      error:
...
const addEntityLayout = (rootDir: string, layoutId: string): void => {
