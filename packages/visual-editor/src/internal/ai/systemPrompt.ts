...
All pages should have an ExpandedHeader, HeroSection, CoreInfoSection, PromoSection, and ExpandedFooter unless the user explicitly says not to include one of those sections.
