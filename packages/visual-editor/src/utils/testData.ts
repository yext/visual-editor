...
export const testMarketerTailwindConfig: TailwindConfig = {
  colors: {
...
export const testDeveloperTailwindConfig: TailwindConfig = {
  colors: {
...
export const testMergedConfig: TailwindConfig = {
  colors: {
