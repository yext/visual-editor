...
import { headerFooterImageFillTypeMigration } from "../components/migrations/0081_header_footer_image_fill_type.ts";
...
describe("migrate", () => {
  ...
  it("adds default fill behavior to expanded header and footer images", () => {
    const migratedData = migrate(
      {
        root: { props: { version: 0 } },
        content: [
        ...
        components: {
          ...
          PrimaryHeaderSlot: {
            fields: {
              slots: {
                type: "object",
                objectFields: { LogoSlot: { type: "slot" } },
              },
            },
          },
          ImageSlot: { fields: {} },
          ...
          FooterLogoSlot: { fields: {} },
          FooterUtilityImagesSlot: { fields: {} },
        },
      } as any,
      {}
    );
